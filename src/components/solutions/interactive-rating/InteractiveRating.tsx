...
const VoteScore = (props: Score): JSX.Element => {
  const { value, selected } = props;

  return (
    <div
      className={selected ? 'star-container star-selected' : 'star-container star-default-background'}
      onClick={() => {
        props.onScoreClick!(value);
      }}
    >
      <span className="vote-number">{value}</span>
    </div>
  );
};

export const InteractiveRating = (): JSX.Element => {
  const [scoresAvailable, setScoresAvailable] = useState<Score[]>([
      ...
      <div className="content-container">
        <div className="background">
          <div className="container">
            {/* todo - fix. hard to use class/variable here because if I use it, styles for selected vote are broken */}
            <div className="star-container" style={{ backgroundColor: 'hsl(213deg 30% 24%)', maxWidth: '40px' }}>
              <svg className="star" width="17" height="16" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="background">
            <div className="container">
              ...
              <div className="feedback-msg-container">
                <p className="feedback-msg">You selected {scoresAvailable.find((x) => x.selected)?.value} out of 5</p>
              </div>
              <h2 className="thank-you-msg">Thank you!</h2>
              <p className="para">
